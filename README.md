...
意味が2つある語は**2枚並べて違いを見せます**。
`bank` なら「銀行」と「土手」、`court` なら「裁判所」と「コート」、
`second` なら「時計の最小単位」と「2番目」。
...
data/vocab-senses.js  意味ごとの例文（199語・509例文）と豆知識（64語）
data/vocab-art.js     単語のイメージ図（65語・インラインSVG）
