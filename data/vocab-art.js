/* ============================================================
   ...
   ============================================================ */
/* 補助関数はこの中に閉じ込める。
   素の const で置くと、別のファイルが同じ名前を使った瞬間に
   構文エラーでアプリ全体が無言で止まる。出すのは VOCAB_ART ひとつだけ。 */
const VOCAB_ART = (() => {
  ...
  average: A(`
    ...
    ${LB(120,124,'ならして真ん中')}`),
  /* ---------- 時間（同じ軸の上で、どこを指すかを塗り分ける） ---------- */
  time: A(`
    <path d="M26 66 h188" stroke="var(--accent)" stroke-width="2.5" opacity=".4"/>
    <path d="M214 66 l-14 7 v-14 z" fill="var(--accent)" opacity=".4"/>
    ${[52,90,128,166].map((x,i)=>`<circle cx="${x}" cy="66" r="${7+i}" fill="var(--accent)" opacity="${0.35+i*0.15}"/>`).join('')}
    ${LB(120,124,'流れ続けるもの')}`),
  past: A(`
    <path d="M26 66 h188" stroke="var(--accent)" stroke-width="2" opacity=".3"/>
    <path d="M26 66 h92" stroke="var(--accent)" stroke-width="6" stroke-linecap="round"/>
    <circle cx="120" cy="66" r="10" fill="var(--accent)"/>
    ${LB(120,94,'いま')}
    ${LB(70,44,'過ぎた側')}
    ${LB(120,126,'いまより手前')}`),
  present: A(SP2 + `
    <path d="M18 62 h86" stroke="var(--accent)" stroke-width="2" opacity=".3"/>
    <circle cx="61" cy="62" r="14" fill="var(--accent)"/>
    ${LB(61,92,'いま')}
    ${LB(61,124,'現在')}
    <rect x="150" y="56" width="60" height="42" rx="4" fill="var(--accent)" opacity=".6"/>
    <path d="M150 68 h60" stroke="var(--bg)" stroke-width="3"/>
    <path d="M180 56 v42" stroke="var(--bg)" stroke-width="3"/>
    <path d="M180 56 q-16 -18 -22 -2 q14 4 22 2 q8 2 22 -2 q-6 -16 -22 2 z" fill="var(--accent)"/>
    ${LB(180,124,'贈り物')}`),
  future: A(`
    <path d="M26 66 h188" stroke="var(--accent)" stroke-width="2" opacity=".3"/>
    <circle cx="120" cy="66" r="10" fill="var(--accent)"/>
    <path d="M132 66 h74" stroke="var(--accent)" stroke-width="6" stroke-linecap="round" opacity=".55"/>
    <path d="M214 66 l-14 7 v-14 z" fill="var(--accent)" opacity=".55"/>
    ${LB(120,94,'いま')}
    ${LB(172,44,'まだ来ない側')}
    ${LB(120,126,'いまより先')}`),
  moment: A(`
    <path d="M26 74 h188" stroke="var(--accent)" stroke-width="2" opacity=".3"/>
    <rect x="116" y="50" width="8" height="48" rx="3" fill="var(--accent)"/>
    <path d="M92 36 h56" stroke="var(--accent)" stroke-width="2" opacity=".5"/>
    <path d="M92 36 l8 -5 v10 z M148 36 l-8 -5 v10 z" fill="var(--accent)" opacity=".5"/>
    ${LB(120,26,'幅を持たない')}
    ${LB(120,124,'その一点')}`),
  period: A(`
    <path d="M26 74 h188" stroke="var(--accent)" stroke-width="2" opacity=".3"/>
    <rect x="74" y="58" width="92" height="32" rx="4" fill="var(--accent)" opacity=".5"/>
    <path d="M74 44 v50 M166 44 v50" stroke="var(--accent)" stroke-width="3"/>
    <path d="M74 36 h92" stroke="var(--accent)" stroke-width="2" opacity=".5"/>
    <path d="M74 36 l8 -5 v10 z M166 36 l-8 -5 v10 z" fill="var(--accent)" opacity=".5"/>
    ${LB(120,26,'始まりと終わりがある')}
    ${LB(120,124,'ひと区切りの長さ')}`),
  century: A(`
    <path d="M26 82 h188" stroke="var(--accent)" stroke-width="2.5"/>
    ${[...Array(10)].map((_,i)=>`<rect x="${34+i*18}" y="${74}" width="12" height="8"
      fill="var(--accent)" opacity="${0.35+(i%2)*0.3}"/>`).join('')}
    <path d="M34 60 h180" stroke="var(--accent)" stroke-width="2" opacity=".5"/>
    <path d="M34 60 l8 -5 v10 z M214 60 l-8 -5 v10 z" fill="var(--accent)" opacity=".5"/>
    ${LB(120,48,'10年×10')}
    ${LB(120,120,'100年ひと区切り')}`),
  age: A(SP2 + `
    <circle cx="36" cy="82" r="9" fill="var(--accent)" opacity=".35"/>
    <circle cx="61" cy="66" r="12" fill="var(--accent)" opacity=".65"/>
    <circle cx="88" cy="48" r="15" fill="var(--accent)"/>
    <path d="M22 98 h78" stroke="var(--accent)" stroke-width="2" opacity=".4"/>
    ${LB(61,124,'年齢')}
    <path d="M138 78 h84" stroke="var(--accent)" stroke-width="2" opacity=".35"/>
    <rect x="146" y="58" width="30" height="24" rx="3" fill="var(--accent)" opacity=".4"/>
    <rect x="184" y="50" width="30" height="32" rx="3" fill="var(--accent)" opacity=".8"/>
    ${LB(180,124,'時代')}`),
  date: A(SP2 + `
    <rect x="24" y="38" width="74" height="60" rx="5" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    <rect x="24" y="38" width="74" height="14" rx="5" fill="var(--accent)"/>
    <text x="61" y="82" text-anchor="middle" font-size="24" font-weight="700"
      fill="var(--accent)" font-family="-apple-system,sans-serif">7</text>
    ${LB(61,124,'日付')}
    <circle cx="160" cy="58" r="13" fill="var(--accent)"/>
    <circle cx="200" cy="58" r="13" fill="var(--accent)"/>
    <path d="M180 84 q-4 -10 -12 -10 q-10 0 -10 9 q0 10 22 20 q22 -10 22 -20 q0 -9 -10 -9
      q-8 0 -12 10 z" fill="var(--accent)" opacity=".6"/>
    ${LB(180,124,'会う約束')}`),

  /* ---------- 数量（同じ入れ物の中身の量で比べる） ---------- */
  all: A(SP2 + `
    <circle cx="61" cy="62" r="32" fill="none" stroke="var(--accent)" stroke-width="3"/>
    ${[[46,50],[76,50],[46,76],[76,76],[61,63]].map(([x,y])=>
      `<circle cx="${x}" cy="${y}" r="9" fill="var(--accent)"/>`).join('')}
    ${LB(61,120,'中身が全部')}
    <circle cx="180" cy="62" r="32" fill="none" stroke="var(--accent)" stroke-width="3"/>
    ${LB(180,120,'空（none）')}`),
  some: A(SP2 + `
    <circle cx="61" cy="62" r="32" fill="none" stroke="var(--accent)" stroke-width="3"/>
    ${[[48,56],[74,56],[61,78]].map(([x,y])=>
      `<circle cx="${x}" cy="${y}" r="9" fill="var(--accent)"/>`).join('')}
    ${LB(61,120,'いくらか入っている')}
    <circle cx="180" cy="62" r="32" fill="none" stroke="var(--accent)" stroke-width="3"
      stroke-dasharray="6 5"/>
    <text x="180" y="70" text-anchor="middle" font-size="22" fill="var(--accent)"
      font-family="-apple-system,sans-serif">?</text>
    ${LB(180,120,'あるか不明（any）')}`),
  many: A(SP2 + `
    ${[[42,44],[61,44],[80,44],[42,62],[61,62],[80,62],[42,80],[61,80],[80,80]].map(([x,y])=>
      `<circle cx="${x}" cy="${y}" r="7" fill="var(--accent)"/>`).join('')}
    ${LB(61,120,'数が多い')}
    ${[[168,62],[192,62]].map(([x,y])=>`<circle cx="${x}" cy="${y}" r="7" fill="var(--accent)" opacity=".6"/>`).join('')}
    ${LB(180,120,'少ない（few）')}`),
  few: A(SP2 + `
    ${[[52,62],[74,62]].map(([x,y])=>`<circle cx="${x}" cy="${y}" r="8" fill="var(--accent)"/>`).join('')}
    ${LB(61,120,'ほとんど無い')}
    ${[[160,44],[180,44],[200,44],[160,62],[180,62],[200,62],[160,80],[180,80],[200,80]].map(([x,y])=>
      `<circle cx="${x}" cy="${y}" r="7" fill="var(--accent)" opacity=".6"/>`).join('')}
    ${LB(180,120,'多い（many）')}`),
more: A(SP2 + `
  <rect x="34" y="34" width="26" height="64" rx="3" fill="var(--accent)" opacity=".4"/>
  <rect x="70" y="20" width="26" height="78" rx="3" fill="var(--accent)"/>
  ${LB(61,124,'それより多く')}
  <rect x="146" y="34" width="26" height="64" rx="3" fill="var(--accent)" opacity=".4"/>
  <rect x="182" y="58" width="26" height="40" rx="3" fill="var(--accent)"/>
  ${LB(180,124,'それより少なく（less）')}`),
  less: A(SP2 + `
    <rect x="34" y="34" width="26" height="64" rx="3" fill="var(--accent)" opacity=".4"/>
    <rect x="70" y="58" width="26" height="40" rx="3" fill="var(--accent)"/>
    ${LB(61,124,'それより少なく')}
    <rect x="146" y="34" width="26" height="64" rx="3" fill="var(--accent)" opacity=".4"/>
    <rect x="182" y="20" width="26" height="78" rx="3" fill="var(--accent)"/>
    ${LB(180,124,'それより多く（more）')}`),
  most: A(SP2 + `
    <circle cx="61" cy="60" r="32" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M61 60 L61 28 A32 32 0 1 1 38 82 Z" fill="var(--accent)" opacity=".75"/>
    ${LB(61,118,'大部分')}
    <circle cx="180" cy="60" r="32" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M180 60 L180 28 A32 32 0 0 1 203 39 Z" fill="var(--accent)" opacity=".75"/>
    ${LB(180,118,'最少（least）')}`),
  least: A(SP2 + `
    ${[34,58,82].map((x,i)=>`<rect x="${x-9}" y="${98-(14+i*24)}" width="18" height="${14+i*24}"
      rx="3" fill="var(--accent)" opacity="${i===0?1:0.35}"/>`).join('')}
    ${LB(61,124,'いちばん少ない')}
    ${[152,180,208].map((x,i)=>`<rect x="${x-9}" y="${98-(14+i*24)}" width="18" height="${14+i*24}"
      rx="3" fill="var(--accent)" opacity="${i===2?1:0.35}"/>`).join('')}
    ${LB(180,124,'いちばん多い（most）')}`),
  amount: A(`
    <path d="M76 26 v66 a44 24 0 0 0 88 0 v-66" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M78 58 v34 a42 22 0 0 0 84 0 v-34 z" fill="var(--accent)" opacity=".5"/>
    <path d="M182 58 h14 M182 92 h14 M189 58 v34" stroke="var(--accent)" stroke-width="2"/>
    <path d="M189 58 l-4 6 h8 z M189 92 l-4 -6 h8 z" fill="var(--accent)"/>
    ${LB(120,126,'どれだけ入っているか')}`),
  number: A(SP2 + `
    ${[...Array(7)].map((_,i)=>`<circle cx="${26+i*12}" cy="62" r="5" fill="var(--accent)"
      opacity="${0.4+i*0.09}"/>`).join('')}
    ${LB(61,120,'いくつあるか')}
    <rect x="150" y="42" width="60" height="38" rx="5" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    <text x="180" y="70" text-anchor="middle" font-size="22" font-weight="700"
      fill="var(--accent)" font-family="-apple-system,sans-serif">7</text>
    ${LB(180,120,'番号（付けた名札）')}`),
  figure: A(SP2 + `
    <text x="61" y="76" text-anchor="middle" font-size="34" font-weight="700"
      fill="var(--accent)" font-family="-apple-system,sans-serif">42</text>
    ${LB(61,124,'数字')}
    <circle cx="180" cy="42" r="12" fill="var(--accent)"/>
    <path d="M166 62 q14 8 28 0 l6 34 h-40 z" fill="var(--accent)"/>
    <rect x="146" y="26" width="68" height="76" rx="4" fill="none" stroke="var(--accent)"
      stroke-width="2" stroke-dasharray="5 4" opacity=".5"/>
    ${LB(180,124,'姿・人物')}`),
  rate: A(SP2 + `
    <circle cx="61" cy="60" r="30" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M61 60 L61 30 A30 30 0 0 1 87 75 Z" fill="var(--accent)"/>
    ${LB(61,118,'全体に対する割合')}
    ${[0,1,2,3,4].map(i=>`<path d="M${156+i*12} 52 l3.5 7 7.5 1 -5.5 5 1.5 8 -6.5 -4 -6.5 4 1.5 -8 -5.5 -5 7.5 -1 z"
      fill="var(--accent)" opacity="${i<3?1:0.25}"/>`).join('')}
    ${LB(180,118,'評価する')}`),
  percent: A(`
    <rect x="42" y="50" width="156" height="30" rx="4" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    <rect x="42" y="50" width="62" height="30" rx="4" fill="var(--accent)" opacity=".7"/>
    ${[42,73,104,135,166,197].map(x=>`<path d="M${x} 80 v8" stroke="var(--accent)" stroke-width="2" opacity=".5"/>`).join('')}
    ${LB(70,106,'40')} ${LB(120,36,'100を基準にした数')}
    ${LB(120,126,'パーセント')}`),
  degree: A(SP2 + `
    <path d="M24 90 a38 38 0 0 1 74 0" fill="none" stroke="var(--accent)" stroke-width="3" opacity=".35"/>
    <path d="M61 90 L34 66" stroke="var(--accent)" stroke-width="3"/>
    <circle cx="61" cy="90" r="5" fill="var(--accent)"/>
    ${LB(61,118,'どのくらいか（程度）')}
    <path d="M164 34 h32 l8 12 h-48 z" fill="var(--accent)"/>
    <path d="M180 46 v22" stroke="var(--accent)" stroke-width="3"/>
    <rect x="158" y="68" width="44" height="26" rx="3" fill="var(--accent)" opacity=".4"/>
    ${LB(180,118,'学位')}`),
  price: A(`
    <rect x="58" y="34" width="70" height="52" rx="5" fill="var(--accent)" opacity=".5"/>
    <path d="M134 40 h50 l16 20 -16 20 h-50 z" fill="var(--accent)"/>
    <circle cx="148" cy="60" r="5" fill="var(--bg)"/>
    <text x="172" y="66" text-anchor="middle" font-size="16" font-weight="700"
      fill="var(--bg)" font-family="-apple-system,sans-serif">¥</text>
    ${LB(120,120,'そのものに付いた値')}`),
  cost: A(`
    <rect x="44" y="40" width="58" height="44" rx="5" fill="var(--accent)" opacity=".4"/>
    <path d="M114 62 h22" stroke="var(--accent)" stroke-width="3"/>
    <path d="M148 62 l-14 7 v-14 z" fill="var(--accent)"/>
    ${[[166,44],[192,44],[166,70],[192,70]].map(([x,y])=>
      `<circle cx="${x}" cy="${y}" r="9" fill="var(--accent)" opacity=".8"/>`).join('')}
    ${LB(120,120,'手に入れるのに要る分')}`),
  tax: A(`
    <rect x="36" y="42" width="60" height="44" rx="4" fill="var(--accent)" opacity=".7"/>
    <path d="M108 64 h24" stroke="var(--accent)" stroke-width="3"/>
    <path d="M144 64 l-14 7 v-14 z" fill="var(--accent)"/>
    <rect x="156" y="36" width="56" height="50" rx="4" fill="var(--accent)" opacity=".35"
      stroke="var(--accent)" stroke-width="2.5"/>
    <path d="M170 36 l14 -14 14 14" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    <path d="M60 36 l-10 -10 M72 36 v-14" stroke="var(--accent)" stroke-width="2" opacity=".4"/>
    ${LB(120,120,'そこから公へ納める分')}`),
  fund: A(`
    <path d="M74 44 q0 -12 12 -12 h68 q12 0 12 12 v46 q0 12 -12 12 h-68 q-12 0 -12 -12 z"
      fill="var(--accent)" opacity=".25" stroke="var(--accent)" stroke-width="2.5"/>
    ${[[98,58],[120,58],[142,58],[98,80],[120,80],[142,80]].map(([x,y])=>
      `<circle cx="${x}" cy="${y}" r="8" fill="var(--accent)" opacity=".75"/>`).join('')}
    <path d="M120 24 v-8" stroke="var(--accent)" stroke-width="2.5"/>
    <path d="M120 32 l-6 -10 h12 z" fill="var(--accent)"/>
    ${LB(120,128,'目的のために積んだ金')}`),
  credit: A(SP2 + `
    <rect x="22" y="44" width="78" height="48" rx="5" fill="var(--accent)" opacity=".75"/>
    <rect x="22" y="56" width="78" height="10" fill="var(--bg)" opacity=".5"/>
    <rect x="32" y="74" width="24" height="8" rx="2" fill="var(--bg)" opacity=".7"/>
    ${LB(61,120,'後払いの信用')}
    <circle cx="180" cy="58" r="20" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M168 58 l9 9 16 -18" fill="none" stroke="var(--accent)" stroke-width="3.5" stroke-linecap="round"/>
    ${LB(180,120,'信用・功績')}`),
  word: A(SP2 + `
    <rect x="26" y="50" width="70" height="26" rx="6" fill="var(--accent)" opacity=".7"/>
    <path d="M36 63 h50" stroke="var(--bg)" stroke-width="3"/>
    ${LB(61,118,'1語のかたまり')}
    <path d="M140 42 h80 v36 h-46 l-14 14 v-14 h-20 z" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    ${[54,66].map(y=>`<path d="M152 ${y} h56" stroke="var(--accent)" stroke-width="2" opacity=".55"/>`).join('')}
    ${LB(180,118,'言葉・ひとこと')}`),
  sport: A(`
    <circle cx="64" cy="70" r="24" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M64 46 v48 M40 70 h48" stroke="var(--accent)" stroke-width="2" opacity=".45"/>
    <circle cx="150" cy="38" r="12" fill="var(--accent)"/>
    <path d="M150 52 v26 M150 78 l-14 22 M150 78 l16 20" stroke="var(--accent)"
      stroke-width="6" stroke-linecap="round" fill="none"/>
    <path d="M150 60 l-22 -10 M150 60 l24 -6" stroke="var(--accent)" stroke-width="5" stroke-linecap="round"/>
    ${LB(120,126,'体を使って競うこと')}`),
  /* ---------- 気持ち（顔と、心の向きで描き分ける） ---------- */
  love: A(`
    <path d="M120 100 C66 68 68 34 94 34 c12 0 22 9 26 16 4 -7 14 -16 26 -16 26 0 28 34 -26 66 z"
      fill="var(--accent)"/>
    ${[[58,40],[182,40],[52,78],[188,78]].map(([x,y])=>
      `<path d="M${x} ${y} l${x<120?7:-7} ${y<62?6:-6}" stroke="var(--accent)" stroke-width="2.5" opacity=".45"/>`).join('')}
    ${LB(120,124,'強く引かれる気持ち')}`),
  happy: A(SP2 + `
    <circle cx="61" cy="58" r="28" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <circle cx="51" cy="50" r="3.5" fill="var(--accent)"/><circle cx="71" cy="50" r="3.5" fill="var(--accent)"/>
    <path d="M46 66 q15 16 30 0" fill="none" stroke="var(--accent)" stroke-width="3.5" stroke-linecap="round"/>
    ${[[30,32],[92,32]].map(([x,y])=>`<path d="M${x} ${y} l${x<61?6:-6} 6" stroke="var(--accent)" stroke-width="2.5" opacity=".5"/>`).join('')}
    ${LB(61,118,'うれしい')}
    <circle cx="180" cy="58" r="28" fill="none" stroke="var(--muted)" stroke-width="3" opacity=".6"/>
    <circle cx="170" cy="52" r="3.5" fill="var(--muted)" opacity=".6"/><circle cx="190" cy="52" r="3.5" fill="var(--muted)" opacity=".6"/>
    <path d="M166 74 q14 -14 28 0" fill="none" stroke="var(--muted)" stroke-width="3.5"
      stroke-linecap="round" opacity=".6"/>
    ${LB(180,118,'悲しい（sad）')}`),
  fear: A(`
    <circle cx="74" cy="58" r="26" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <circle cx="65" cy="50" r="5" fill="var(--accent)"/><circle cx="85" cy="50" r="5" fill="var(--accent)"/>
    <ellipse cx="74" cy="72" rx="8" ry="10" fill="var(--accent)"/>
    <path d="M150 28 l34 62 h-68 z" fill="var(--accent)" opacity=".35"
      stroke="var(--accent)" stroke-width="2.5"/>
    <path d="M150 48 v22 M150 78 v4" stroke="var(--accent)" stroke-width="3"/>
    <path d="M110 58 h-8" stroke="var(--accent)" stroke-width="2.5"/>
    ${LB(120,120,'怖いものから身を引く')}`),
  hope: A(`
    <circle cx="72" cy="66" r="14" fill="var(--accent)"/>
    <path d="M90 60 L156 36" stroke="var(--accent)" stroke-width="3" stroke-dasharray="6 5"/>
    <path d="M168 32 l-16 0 6 10 z" fill="var(--accent)"/>
    <path d="M182 26 l4 9 10 1 -7 7 2 10 -9 -5 -9 5 2 -10 -7 -7 10 -1 z" fill="var(--accent)" opacity=".8"/>
    <path d="M42 96 h152" stroke="var(--accent)" stroke-width="2" opacity=".3"/>
    ${LB(120,124,'先に良いものを見ている')}`),
  wish: A(`
    <path d="M120 22 l7 15 17 2 -12 12 3 17 -15 -8 -15 8 3 -17 -12 -12 17 -2 z" fill="var(--accent)"/>
    <path d="M96 84 q24 -16 48 0" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <circle cx="120" cy="96" r="7" fill="var(--accent)" opacity=".5"/>
    ${[[74,40],[166,40]].map(([x,y])=>`<circle cx="${x}" cy="${y}" r="4" fill="var(--accent)" opacity=".5"/>`).join('')}
    ${LB(120,124,'手の届かないものを願う')}`),
  dream: A(`
    <rect x="34" y="72" width="76" height="14" rx="4" fill="var(--accent)" opacity=".4"/>
    <circle cx="56" cy="64" r="11" fill="var(--accent)"/>
    <path d="M132 34 q-10 0 -10 10 q-12 0 -12 11 q0 11 12 11 h52 q14 0 14 -13 q0 -13 -14 -13
      q-2 -12 -16 -12 q-12 0 -16 6 z" fill="var(--accent)" opacity=".3"
      stroke="var(--accent)" stroke-width="2"/>
    ${[[100,74,5],[88,84,4],[78,92,3]].map(([x,y,r])=>
      `<circle cx="${x}" cy="${y}" r="${r}" fill="var(--accent)" opacity=".4"/>`).join('')}
    ${LB(120,124,'眠りの中で見るもの・望み')}`),
  worry: A(`
    <circle cx="74" cy="62" r="26" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M62 50 q6 -6 12 0 M78 50 q6 -6 12 0" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    <path d="M62 76 q12 -8 24 0" fill="none" stroke="var(--accent)" stroke-width="3" stroke-linecap="round"/>
    ${[[132,38],[158,52],[184,34],[150,80],[180,72]].map(([x,y],i)=>
      `<path d="M${x} ${y} q8 -8 14 0 q6 8 14 0" fill="none" stroke="var(--accent)"
        stroke-width="2" opacity="${0.55-i*0.06}"/>`).join('')}
    ${LB(120,120,'頭の中がざわつく')}`),

  /* ---------- 伝える（口・耳・向きで描き分ける） ---------- */
  speak: A(`
    <circle cx="78" cy="52" r="20" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <ellipse cx="78" cy="60" rx="7" ry="9" fill="var(--accent)"/>
    ${[24,40,56].map((d,i)=>`<path d="M${108+i*14} ${52-d*0.55} q${d*0.45} ${d*0.55} 0 ${d*1.1}"
      fill="none" stroke="var(--accent)" stroke-width="3" opacity="${0.85-i*0.22}"/>`).join('')}
    ${LB(120,120,'口から外へ出す')}`),
  talk: A(`
    <circle cx="60" cy="56" r="17" fill="var(--accent)"/>
    <circle cx="180" cy="56" r="17" fill="var(--accent)"/>
    <path d="M84 44 h34" stroke="var(--accent)" stroke-width="3"/>
    <path d="M132 44 l-14 6 v-12 z" fill="var(--accent)"/>
    <path d="M156 68 h-34" stroke="var(--accent)" stroke-width="3"/>
    <path d="M108 68 l14 -6 v12 z" fill="var(--accent)"/>
    ${LB(120,118,'行き来がある')}`),
  tell: A(`
    <circle cx="58" cy="60" r="17" fill="var(--accent)"/>
    <path d="M82 60 h72" stroke="var(--accent)" stroke-width="4"/>
    <path d="M170 60 l-16 8 v-16 z" fill="var(--accent)"/>
    <circle cx="196" cy="60" r="15" fill="var(--accent)" opacity=".4"/>
    ${LB(120,118,'相手に届ける（相手が要る）')}`),
  ask: A(`
    <circle cx="58" cy="62" r="17" fill="var(--accent)"/>
    <path d="M82 52 h64" stroke="var(--accent)" stroke-width="3"/>
    <path d="M160 52 l-14 7 v-14 z" fill="var(--accent)"/>
    <text x="114" y="42" text-anchor="middle" font-size="16" fill="var(--accent)"
      font-family="-apple-system,sans-serif">?</text>
    <path d="M146 78 h-64" stroke="var(--accent)" stroke-width="3" stroke-dasharray="5 4" opacity=".5"/>
    <path d="M68 78 l14 -7 v14 z" fill="var(--accent)" opacity=".5"/>
    <circle cx="184" cy="62" r="15" fill="var(--accent)" opacity=".4"/>
    ${LB(120,120,'投げて返事を待つ')}`),
  hear: A(SP2 + `
    <path d="M68 40 q20 -6 20 22 q0 28 -20 22 q-8 -22 0 -44 z" fill="none" stroke="var(--accent)" stroke-width="3"/>
    ${[26,44].map((d,i)=>`<path d="M${44-i*16} ${62-d*0.5} q-${d*0.4} ${d*0.5} 0 ${d}"
      fill="none" stroke="var(--accent)" stroke-width="2.5" opacity="${0.6-i*0.25}"/>`).join('')}
    ${LB(61,124,'入ってくる')}
    <path d="M186 40 q20 -6 20 22 q0 28 -20 22 q-8 -22 0 -44 z" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M160 62 h-14" stroke="var(--accent)" stroke-width="3"/>
    <path d="M146 62 l8 -5 v10 z" fill="var(--accent)"/>
    ${LB(180,124,'向ける（listen）')}`),
  sign: A(`
    <rect x="34" y="34" width="52" height="52" rx="4" fill="var(--accent)" opacity=".7"/>
    <path d="M46 60 h28" stroke="var(--bg)" stroke-width="5"/>
    <path d="M60 86 v18" stroke="var(--accent)" stroke-width="3"/>
    <path d="M112 76 q14 -22 26 -6 q10 14 24 -12" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M104 92 h84" stroke="var(--accent)" stroke-width="2" opacity=".4"/>
    <path d="M182 42 l12 -6 6 10 -30 26 -12 4 4 -12 z" fill="var(--accent)" opacity=".8"/>
    ${LB(120,124,'知らせる印・署名')}`),
  report: A(`
    <circle cx="56" cy="46" r="14" fill="var(--accent)"/>
    <rect x="44" y="64" width="24" height="30" rx="6" fill="var(--accent)"/>
    <path d="M82 58 h30" stroke="var(--accent)" stroke-width="3"/>
    <path d="M126 58 l-14 7 v-14 z" fill="var(--accent)"/>
    <rect x="140" y="28" width="70" height="72" rx="4" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    ${[46,58,70,82].map(y=>`<path d="M152 ${y} h46" stroke="var(--accent)" stroke-width="2" opacity=".5"/>`).join('')}
    ${LB(120,128,'見たことを上へ上げる')}`),
  news: A(`
    <circle cx="52" cy="60" r="16" fill="var(--accent)" opacity=".4"/>
    ${[30,48,66].map((d,i)=>`<path d="M${74+i*14} ${60-d*0.5} q${d*0.4} ${d*0.5} 0 ${d}"
      fill="none" stroke="var(--accent)" stroke-width="3" opacity="${0.85-i*0.2}"/>`).join('')}
    <rect x="140" y="34" width="74" height="54" rx="3" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    <rect x="148" y="42" width="58" height="10" rx="2" fill="var(--accent)"/>
    ${[60,70,80].map(y=>`<path d="M148 ${y} h26 M182 ${y} h24" stroke="var(--accent)"
      stroke-width="2" opacity=".5"/>`).join('')}
    ${LB(120,120,'新しく知らされたこと')}`),
  article: A(SP2 + `
    <rect x="22" y="32" width="78" height="66" rx="3" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    <rect x="30" y="40" width="62" height="10" rx="2" fill="var(--accent)"/>
    ${[58,68,78,88].map(y=>`<path d="M30 ${y} h28 M64 ${y} h28" stroke="var(--accent)"
      stroke-width="2" opacity=".5"/>`).join('')}
    ${LB(61,124,'記事')}
    ${[[158,48],[202,48],[158,80],[202,80]].map(([x,y])=>
      `<rect x="${x-16}" y="${y-13}" width="32" height="26" rx="4" fill="var(--accent)" opacity=".55"/>`).join('')}
    ${LB(180,124,'品物（ひとつずつ）')}`),
  story: A(SP2 + `
    <path d="M24 44 q30 -14 60 0 v46 q-30 -14 -60 0 z" fill="var(--accent)" opacity=".55"/>
    <path d="M100 40 q-10 6 -10 16 q0 8 10 8 v10 l12 -12" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    ${LB(61,124,'語られる話')}
    ${[0,1,2].map(i=>`<rect x="146" y="${76-i*22}" width="70" height="20" rx="2"
      fill="var(--accent)" opacity="${0.35+i*0.2}" stroke="var(--bg)" stroke-width="1.5"/>`).join('')}
    ${LB(180,124,'建物の階')}`),

  /* ---------- 始まりと終わり（同じ線の上で位置を変える） ---------- */
  begin: A(`
    <path d="M26 66 h188" stroke="var(--accent)" stroke-width="2" opacity=".25"/>
    <circle cx="52" cy="66" r="13" fill="var(--accent)"/>
    <path d="M72 66 h122" stroke="var(--accent)" stroke-width="5" stroke-linecap="round" opacity=".5"/>
    <path d="M52 40 v-12" stroke="var(--accent)" stroke-width="2.5"/>
    ${LB(52,24,'ここから')}
    ${LB(120,126,'始まる点')}`),
  start: A(SP2 + `
    <path d="M18 66 h86" stroke="var(--accent)" stroke-width="2" opacity=".25"/>
    <path d="M30 44 v44" stroke="var(--accent)" stroke-width="4"/>
    <circle cx="46" cy="66" r="12" fill="var(--accent)"/>
    <path d="M64 66 h32" stroke="var(--accent)" stroke-width="3"/>
    <path d="M104 66 l-12 6 v-12 z" fill="var(--accent)"/>
    ${LB(61,124,'動き出す')}
    <circle cx="180" cy="62" r="24" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M180 62 v-16 M180 38 v-8" stroke="var(--accent)" stroke-width="3"/>
    <path d="M172 62 h16" stroke="var(--accent)" stroke-width="3"/>
    ${LB(180,124,'機械をかける')}`),
  end: A(`
    <path d="M26 66 h188" stroke="var(--accent)" stroke-width="2" opacity=".25"/>
    <path d="M46 66 h122" stroke="var(--accent)" stroke-width="5" stroke-linecap="round" opacity=".5"/>
    <circle cx="188" cy="66" r="13" fill="var(--accent)"/>
    <path d="M188 40 v-12" stroke="var(--accent)" stroke-width="2.5"/>
    ${LB(188,24,'ここまで')}
    ${LB(120,126,'終わる点')}`),
  finish: A(`
    <path d="M26 66 h150" stroke="var(--accent)" stroke-width="4" stroke-linecap="round"/>
    <circle cx="160" cy="66" r="12" fill="var(--accent)"/>
    <rect x="186" y="26" width="6" height="76" rx="2" fill="var(--accent)"/>
    ${[0,1,2,3].map(r=>[0,1].map(c=>`<rect x="${192+c*11}" y="${28+r*11}" width="11" height="11"
      fill="var(--accent)" opacity="${(r+c)%2?1:0.25}"/>`).join('')).join('')}
    ${LB(110,120,'最後までやりきる')}`),
  continue: A(`
    <path d="M26 66 h72" stroke="var(--accent)" stroke-width="5" stroke-linecap="round"/>
    <path d="M104 66 h18" stroke="var(--accent)" stroke-width="5" opacity=".4" stroke-dasharray="2 8"/>
    <path d="M128 66 h66" stroke="var(--accent)" stroke-width="5" stroke-linecap="round"/>
    <path d="M212 66 l-18 9 v-18 z" fill="var(--accent)"/>
    <path d="M113 40 v-10" stroke="var(--accent)" stroke-width="2" opacity=".5"/>
    ${LB(113,24,'途切れても')}
    ${LB(120,124,'また先へ続く')}`),
  grow: A(`
    <path d="M36 100 h168" stroke="var(--accent)" stroke-width="2.5"/>
    ${[0,1,2,3].map(i=>{const h=14+i*18, x=58+i*38, s=3+i*3;
      return `<path d="M${x} 100 v-${h}" stroke="var(--accent)" stroke-width="3" opacity="${0.4+i*0.2}"/>
        <path d="M${x} ${100-h} q-${6+s} -${3+s*0.6} -${8+s} -${8+s} q${8+s*0.7} ${1+s*0.3} ${8+s} ${8+s} z"
          fill="var(--accent)" opacity="${0.4+i*0.2}"/>
        <path d="M${x} ${100-h+5} q${6+s} -${3+s*0.6} ${8+s} -${8+s} q-${8+s*0.7} ${1+s*0.3} -${8+s} ${8+s} z"
          fill="var(--accent)" opacity="${0.4+i*0.2}"/>`}).join('')}
    ${LB(120,126,'だんだん大きくなる')}`),

  /* ---------- ものごとの良し悪し ---------- */
  good: A(SP2 + `
    <circle cx="61" cy="58" r="28" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M46 58 l11 12 24 -25" fill="none" stroke="var(--accent)" stroke-width="4.5" stroke-linecap="round"/>
    ${LB(61,118,'良い')}
    <circle cx="180" cy="58" r="28" fill="none" stroke="var(--muted)" stroke-width="3" opacity=".6"/>
    <path d="M166 44 l28 28 M194 44 l-28 28" stroke="var(--muted)" stroke-width="4"
      stroke-linecap="round" opacity=".6"/>
    ${LB(180,118,'悪い（bad）')}`),
  bad: A(SP2 + `
    <circle cx="61" cy="58" r="28" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M47 44 l28 28 M75 44 l-28 28" stroke="var(--accent)" stroke-width="4" stroke-linecap="round"/>
    ${LB(61,118,'悪い')}
    <circle cx="180" cy="58" r="28" fill="none" stroke="var(--muted)" stroke-width="3" opacity=".6"/>
    <path d="M165 58 l11 12 24 -25" fill="none" stroke="var(--muted)" stroke-width="4.5"
      stroke-linecap="round" opacity=".6"/>
    ${LB(180,118,'良い（good）')}`),
  true: A(SP2 + `
    <circle cx="61" cy="58" r="26" fill="none" stroke="var(--accent)" stroke-width="4"/>
    ${LB(61,114,'合っている')}
    <path d="M162 40 l36 36 M198 40 l-36 36" stroke="var(--muted)" stroke-width="4"
      stroke-linecap="round" opacity=".6"/>
    ${LB(180,114,'違う（false）')}`),
  wrong: A(SP2 + `
    <path d="M42 40 l38 38 M80 40 l-38 38" stroke="var(--accent)" stroke-width="4.5" stroke-linecap="round"/>
    ${LB(61,114,'間違っている')}
    <circle cx="180" cy="58" r="26" fill="none" stroke="var(--muted)" stroke-width="4" opacity=".6"/>
    ${LB(180,114,'正しい（right）')}`),
  different: A(SP2 + `
    <rect x="34" y="42" width="26" height="40" rx="4" fill="var(--accent)"/>
    <circle cx="82" cy="62" r="16" fill="var(--muted)" opacity=".55"/>
    ${LB(61,118,'そろっていない')}
    <rect x="152" y="42" width="24" height="40" rx="4" fill="var(--accent)"/>
    <rect x="186" y="42" width="24" height="40" rx="4" fill="var(--accent)"/>
    ${LB(180,118,'同じ（same）')}`),
  small: A(SP2 + `
    <rect x="48" y="50" width="26" height="26" rx="4" fill="var(--accent)"/>
    ${LB(61,114,'小さい')}
    <rect x="146" y="26" width="70" height="70" rx="6" fill="var(--accent)" opacity=".6"/>
    ${LB(180,114,'大きい（big）')}`),
cold: A(SP2 + `
  <rect x="52" y="38" width="18" height="52" rx="9" fill="none" stroke="var(--accent)" stroke-width="3"/>
  <rect x="56" y="76" width="10" height="14" rx="5" fill="var(--accent)"/>
  <circle cx="61" cy="96" r="13" fill="var(--accent)"/>
  ${[0,60,120].map(a=>{const r=a*Math.PI/180;
    return `<line x1="${88-9*Math.cos(r)}" y1="${50-9*Math.sin(r)}" x2="${88+9*Math.cos(r)}" y2="${50+9*Math.sin(r)}" stroke="var(--accent)" stroke-width="2.2" opacity=".65"/>`}).join('')}
  ${LB(61,128,'冷たい・寒い')}
  <circle cx="172" cy="52" r="17" fill="none" stroke="var(--accent)" stroke-width="3"/>
  <path d="M163 47 q9 6 18 0" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
  <path d="M166 60 q6 5 12 0" fill="none" stroke="var(--accent)" stroke-width="2.5" opacity=".7"/>
  ${[[192,66],[202,76],[210,88]].map(([x,y],i)=>
    `<circle cx="${x}" cy="${y}" r="${4.5-i}" fill="var(--accent)" opacity="${0.65-i*0.15}"/>`).join('')}
  ${LB(180,128,'風邪')}`),
  /* ---------- 力とエネルギー ---------- */
  power: A(SP2 + `
    <path d="M64 24 L40 66 h18 l-8 32 26 -44 h-18 z" fill="var(--accent)"/>
    ${LB(61,124,'動かす力・電力')}
    <circle cx="180" cy="42" r="12" fill="var(--accent)"/>
    <rect x="170" y="58" width="20" height="24" rx="5" fill="var(--accent)"/>
    ${[[150,72],[210,72]].map(([x,y])=>`<circle cx="${x}" cy="${y}" r="9" fill="var(--accent)" opacity=".35"/>`).join('')}
    <path d="M146 92 h68" stroke="var(--accent)" stroke-width="2" opacity=".4"/>
    ${LB(180,124,'上に立つ力＝権力')}`),
  energy: A(`
    <circle cx="120" cy="60" r="20" fill="var(--accent)"/>
    ${[0,45,90,135,180,225,270,315].map((a,i)=>{const r=a*Math.PI/180;
      return `<path d="M${120+28*Math.cos(r)} ${60+28*Math.sin(r)} l${14*Math.cos(r)} ${14*Math.sin(r)}"
        stroke="var(--accent)" stroke-width="${i%2?2.5:4}" stroke-linecap="round" opacity="${i%2?0.5:0.9}"/>`}).join('')}
    ${LB(120,124,'たまっていて外へ出る力')}`),
  force: A(SP2 + `
    <rect x="62" y="48" width="36" height="36" rx="4" fill="var(--accent)" opacity=".5"/>
    <path d="M16 66 h38" stroke="var(--accent)" stroke-width="6"/>
    <path d="M60 66 l-14 8 v-16 z" fill="var(--accent)"/>
    <path d="M98 88 l10 10" stroke="var(--accent)" stroke-width="2" opacity=".4"/>
    ${LB(61,124,'押しつける力')}
    ${[152,176,200].map((x,i)=>`
      <circle cx="${x}" cy="46" r="9" fill="var(--accent)" opacity="${0.5+i*0.15}"/>
      <rect x="${x-7}" y="58" width="14" height="20" rx="4" fill="var(--accent)" opacity="${0.5+i*0.15}"/>`).join('')}
    <path d="M140 86 h72" stroke="var(--accent)" stroke-width="2.5"/>
    ${LB(180,124,'まとまった軍')}`),
  military: A(`
    ${[76,120,164].map((x,i)=>`
      <circle cx="${x}" cy="44" r="12" fill="var(--accent)" opacity="${0.55+i*0.15}"/>
      <path d="M${x-14} 32 h28 l-4 -8 h-20 z" fill="var(--accent)" opacity="${0.55+i*0.15}"/>
      <rect x="${x-11}" y="60" width="22" height="30" rx="5" fill="var(--accent)" opacity="${0.55+i*0.15}"/>`).join('')}
    <path d="M50 98 h140" stroke="var(--accent)" stroke-width="3"/>
    ${LB(120,124,'そろって動く組織')}`),
  war: A(`
    <path d="M30 96 L68 34 l14 10 -34 58 z" fill="var(--accent)" opacity=".7"/>
    <path d="M210 96 L172 34 l-14 10 34 58 z" fill="var(--accent)" opacity=".7"/>
    <path d="M96 62 h48" stroke="var(--accent)" stroke-width="3" opacity=".4"/>
    ${[[112,44],[128,44],[120,32]].map(([x,y],i)=>
      `<path d="M${x} ${y} l${i%2?5:-5} -10" stroke="var(--accent)" stroke-width="2.5" opacity=".5"/>`).join('')}
    ${LB(120,124,'ぶつかり合い')}`),
  fight: A(`
    <circle cx="62" cy="46" r="15" fill="var(--accent)"/>
    <rect x="49" y="66" width="26" height="30" rx="6" fill="var(--accent)"/>
    <circle cx="178" cy="46" r="15" fill="var(--accent)"/>
    <rect x="165" y="66" width="26" height="30" rx="6" fill="var(--accent)"/>
    <path d="M80 62 h26 M160 62 h-26" stroke="var(--accent)" stroke-width="5" stroke-linecap="round"/>
    ${[[120,44],[110,34],[130,34]].map(([x,y],i)=>
      `<path d="M${x} ${y} l${i===0?0:(i===1?-5:5)} -10" stroke="var(--accent)" stroke-width="2.5" opacity=".55"/>`).join('')}
    <path d="M112 62 l16 0" stroke="var(--accent)" stroke-width="3" opacity=".3"/>
    ${LB(120,124,'正面からぶつかる')}`),
  race: A(SP2 + `
    ${[44,61,78].map((y,i)=>`
      <circle cx="${28+i*8}" cy="${y}" r="7" fill="var(--accent)" opacity="${0.9-i*0.22}"/>
      <path d="M${40+i*8} ${y} h${30-i*6}" stroke="var(--accent)" stroke-width="2" opacity="${0.6-i*0.15}"/>`).join('')}
    <rect x="90" y="34" width="4" height="54" fill="var(--accent)"/>
    ${LB(61,124,'先を競う')}
    ${[[158,50],[180,44],[202,52]].map(([x,y],i)=>`
      <circle cx="${x}" cy="${y}" r="11" fill="var(--accent)" opacity="${0.4+i*0.2}"/>`).join('')}
    <path d="M140 86 q40 -12 80 0" fill="none" stroke="var(--accent)" stroke-width="2.5" opacity=".5"/>
    ${LB(180,124,'人種（受け継ぐ集団）')}`),
  game: A(`
    <rect x="58" y="34" width="124" height="66" rx="6" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M120 34 v66" stroke="var(--accent)" stroke-width="2" stroke-dasharray="5 4" opacity=".5"/>
    <circle cx="120" cy="67" r="16" fill="none" stroke="var(--accent)" stroke-width="2" opacity=".5"/>
    <circle cx="88" cy="56" r="9" fill="var(--accent)" opacity=".8"/>
    <circle cx="152" cy="78" r="9" fill="var(--accent)" opacity=".5"/>
    ${LB(120,126,'決まりの中で競う')}`),
  team: A(`
    ${[[70,48],[120,42],[170,48]].map(([x,y],i)=>`
      <circle cx="${x}" cy="${y}" r="14" fill="var(--accent)" opacity="${0.6+i*0.12}"/>
      <rect x="${x-12}" y="${y+18}" width="24" height="28" rx="6" fill="var(--accent)" opacity="${0.6+i*0.12}"/>`).join('')}
    <path d="M70 100 q50 16 100 0" fill="none" stroke="var(--accent)" stroke-width="3"/>
    ${LB(120,126,'ひとつの目的で組む')}`),
  player: A(`
    <circle cx="98" cy="34" r="13" fill="var(--accent)"/>
    <path d="M98 48 v28 M98 76 l-16 26 M98 76 l18 24" stroke="var(--accent)"
      stroke-width="7" stroke-linecap="round" fill="none"/>
    <path d="M98 56 l26 -12" stroke="var(--accent)" stroke-width="5" stroke-linecap="round"/>
    <circle cx="142" cy="38" r="12" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M60 106 h120" stroke="var(--accent)" stroke-width="2.5"/>
    ${LB(120,130,'その場でプレーする人')}`),
  score: A(`
    <rect x="50" y="34" width="140" height="44" rx="6" fill="var(--accent)" opacity=".25"
      stroke="var(--accent)" stroke-width="2.5"/>
    <text x="96" y="68" text-anchor="middle" font-size="26" font-weight="700"
      fill="var(--accent)" font-family="-apple-system,sans-serif">3</text>
    <text x="120" y="66" text-anchor="middle" font-size="20" fill="var(--accent)"
      font-family="-apple-system,sans-serif">-</text>
    <text x="146" y="68" text-anchor="middle" font-size="26" font-weight="700"
      fill="var(--accent)" font-family="-apple-system,sans-serif">1</text>
    <path d="M120 84 v14" stroke="var(--accent)" stroke-width="2" opacity=".4"/>
    ${LB(120,124,'取った点')}`),

  /* ---------- 学びと分野 ---------- */
  science: A(`
    <path d="M96 24 v26 L64 96 q-4 8 5 8 h102 q9 0 5 -8 L144 50 V24" fill="none"
      stroke="var(--accent)" stroke-width="3"/>
    <path d="M78 72 h84 l14 24 q4 8 -5 8 h-102 q-9 0 -5 -8 z" fill="var(--accent)" opacity=".45"/>
    <path d="M88 24 h64" stroke="var(--accent)" stroke-width="3"/>
    ${[[104,84],[128,88],[148,82]].map(([x,y])=>
      `<circle cx="${x}" cy="${y}" r="4" fill="var(--accent)" opacity=".6"/>`).join('')}
    ${LB(120,128,'確かめて積み上げる')}`),
  technology: A(`
    <circle cx="120" cy="60" r="18" fill="none" stroke="var(--accent)" stroke-width="4"/>
    ${[0,60,120,180,240,300].map(a=>{const r=a*Math.PI/180;
      return `<rect x="${120+27*Math.cos(r)-6}" y="${60+27*Math.sin(r)-6}" width="12" height="12"
        rx="2" fill="var(--accent)" transform="rotate(${a} ${120+27*Math.cos(r)} ${60+27*Math.sin(r)})"/>`}).join('')}
    <circle cx="120" cy="60" r="7" fill="var(--accent)" opacity=".4"/>
    ${[[56,40],[184,40],[56,86],[184,86]].map(([x,y])=>
      `<circle cx="${x}" cy="${y}" r="7" fill="var(--accent)" opacity=".35"/>`).join('')}
    <path d="M63 43 L100 55 M177 43 L140 55 M63 83 L100 68 M177 83 L140 68"
      stroke="var(--accent)" stroke-width="2" opacity=".35"/>
    ${LB(120,124,'仕組みを作る技')}`),
  art: A(`
    <path d="M80 30 q-36 12 -36 42 q0 32 40 32 q14 0 14 -10 q0 -8 -6 -10 q-4 -2 -4 -6
      q0 -6 8 -6 h14 q26 0 26 -24 q0 -26 -34 -26 q-12 0 -22 8 z"
      fill="none" stroke="var(--accent)" stroke-width="3"/>
    ${[[68,52],[86,42],[106,46],[110,64]].map(([x,y],i)=>
      `<circle cx="${x}" cy="${y}" r="6" fill="var(--accent)" opacity="${0.45+i*0.15}"/>`).join('')}
    <path d="M168 96 L196 34" stroke="var(--accent)" stroke-width="4"/>
    <path d="M168 96 l-8 12 14 -4 z" fill="var(--accent)"/>
    ${LB(120,128,'手で作り出すもの')}`),
  image: A(SP2 + `
    <rect x="24" y="36" width="74" height="58" rx="4" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    <circle cx="44" cy="54" r="7" fill="var(--accent)" opacity=".6"/>
    <path d="M28 88 l24 -26 18 16 14 -12 14 22 z" fill="var(--accent)" opacity=".6"/>
    ${LB(61,120,'画像')}
    <path d="M180 36 q-22 0 -22 18 q0 12 12 18 v10 h20 v-10 q12 -6 12 -18 q0 -18 -22 -18 z"
      fill="none" stroke="var(--accent)" stroke-width="2.5" stroke-dasharray="5 4"/>
    ${[[148,40],[212,40],[146,72],[214,72]].map(([x,y])=>
      `<circle cx="${x}" cy="${y}" r="3.5" fill="var(--accent)" opacity=".5"/>`).join('')}
    ${LB(180,120,'頭に浮かぶ像')}`),
  film: A(SP2 + `
    <rect x="22" y="44" width="78" height="42" rx="3" fill="var(--accent)" opacity=".5"/>
    ${[0,1,2,3].map(i=>`<rect x="${28+i*18}" y="48" width="8" height="6" fill="var(--bg)"/>
      <rect x="${28+i*18}" y="76" width="8" height="6" fill="var(--bg)"/>`).join('')}
    ${LB(61,120,'フィルム')}
    <rect x="146" y="40" width="70" height="46" rx="4" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    <path d="M170 52 l26 12 -26 12 z" fill="var(--accent)"/>
    ${LB(180,120,'映画')}`),
  movie: A(`
    <rect x="62" y="40" width="116" height="62" rx="5" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M106 58 l34 16 -34 16 z" fill="var(--accent)"/>
    <path d="M62 30 h116 l-12 -12 h-92 z" fill="var(--accent)" opacity=".6"/>
    ${[80,104,128,152].map(x=>`<path d="M${x} 30 l6 -12" stroke="var(--bg)" stroke-width="2.5"/>`).join('')}
    ${LB(120,128,'映画')}`),
  stage: A(SP2 + `
    ${[0,1,2].map(i=>`<rect x="${28+i*24}" y="${92-18-i*22}" width="22" height="${18+i*22}"
      rx="2" fill="var(--accent)" opacity="${0.4+i*0.25}"/>`).join('')}
    ${LB(61,124,'段階')}
    <path d="M142 86 h76 l-10 -30 h-56 z" fill="var(--accent)" opacity=".5"/>
    <circle cx="180" cy="44" r="10" fill="var(--accent)"/>
    <path d="M136 30 h88" stroke="var(--accent)" stroke-width="3"/>
    ${LB(180,124,'舞台')}`),
  design: A(`
    <rect x="50" y="26" width="140" height="70" rx="4" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    <path d="M68 78 L94 44 l22 22 18 -30 26 42" fill="none" stroke="var(--accent)"
      stroke-width="2.5" stroke-dasharray="6 4" opacity=".7"/>
    ${[[94,44],[116,66],[134,36]].map(([x,y])=>
      `<circle cx="${x}" cy="${y}" r="4" fill="var(--accent)"/>`).join('')}
    <path d="M40 106 h160" stroke="var(--accent)" stroke-width="2" opacity=".3"/>
    ${LB(120,128,'作る前に形を決める')}`),
  create: A(`
    <circle cx="58" cy="64" r="16" fill="none" stroke="var(--accent)" stroke-width="2.5"
      stroke-dasharray="5 4" opacity=".5"/>
    <path d="M84 64 h36" stroke="var(--accent)" stroke-width="3"/>
    <path d="M132 64 l-14 7 v-14 z" fill="var(--accent)"/>
    <path d="M176 28 l9 20 20 9 -20 9 -9 20 -9 -20 -20 -9 20 -9 z" fill="var(--accent)"/>
    ${LB(120,120,'無いところから生む')}`),
  plan: A(`
    <rect x="52" y="24" width="136" height="72" rx="4" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    ${[0,1,2].map(i=>`
      <circle cx="70" cy="${42+i*20}" r="6" fill="var(--accent)" opacity="${0.9-i*0.25}"/>
      <path d="M86 ${42+i*20} h${84-i*16}" stroke="var(--accent)" stroke-width="2.5" opacity="${0.7-i*0.18}"/>`).join('')}
    <path d="M70 48 v8 M70 68 v8" stroke="var(--accent)" stroke-width="2" opacity=".5"/>
    ${LB(120,124,'先の段取りを決めておく')}`),
  paint: A(SP2 + `
    <path d="M34 34 h30 v34 q0 8 -8 8 h-14 q-8 0 -8 -8 z" fill="var(--accent)" opacity=".5"/>
    <path d="M46 76 v20" stroke="var(--accent)" stroke-width="5"/>
    <path d="M28 96 q18 10 36 0" fill="none" stroke="var(--accent)" stroke-width="5"/>
    ${LB(61,124,'塗る')}
    <path d="M180 34 a30 30 0 1 0 8 59 q-8 -2 -8 -9 q0 -6 7 -6 h9 q18 0 18 -18 q0 -26 -34 -26 z"
      fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    ${[[168,50],[186,44],[200,58]].map(([x,y],i)=>
      `<circle cx="${x}" cy="${y}" r="5" fill="var(--accent)" opacity="${0.5+i*0.18}"/>`).join('')}
    ${LB(180,124,'絵の具')}`),
close: A(SP2 + `
  <rect x="26" y="34" width="70" height="62" rx="4" fill="var(--accent)" opacity=".35"
    stroke="var(--accent)" stroke-width="2.5"/>
  <circle cx="86" cy="66" r="4" fill="var(--accent)"/>
  ${LB(61,124,'閉じる')}
  <circle cx="164" cy="62" r="14" fill="var(--accent)"/>
  <circle cx="198" cy="62" r="14" fill="var(--accent)"/>
  <path d="M178 62 h6" stroke="var(--accent)" stroke-width="2"/>
  <path d="M178 88 h6" stroke="var(--accent)" stroke-width="2"/>
  <path d="M172 88 h-14 M190 88 h14" stroke="var(--accent)" stroke-width="2" opacity=".5"/>
  ${LB(180,124,'すきまが小さい→近い')}`),
  drive: A(SP2 + `
    <rect x="24" y="56" width="74" height="26" rx="6" fill="var(--accent)"/>
    <path d="M38 56 l10 -14 h30 l10 14 z" fill="var(--accent)" opacity=".6"/>
    <circle cx="42" cy="86" r="8" fill="var(--muted)"/><circle cx="82" cy="86" r="8" fill="var(--muted)"/>
    ${LB(61,124,'運転する')}
    <rect x="180" y="48" width="30" height="34" rx="4" fill="var(--accent)" opacity=".5"/>
    ${[52,66,80].map(y=>`
      <path d="M140 ${y} h28" stroke="var(--accent)" stroke-width="3"/>
      <path d="M176 ${y} l-10 5 v-10 z" fill="var(--accent)"/>`).join('')}
    ${LB(180,124,'後ろから押しやる')}`),

  /* ---------- 仕組み・きまり ---------- */
law: A(`
  <path d="M74 22 h92 v82 h-92 z" fill="none" stroke="var(--accent)" stroke-width="3"/>
  <path d="M74 40 h92" stroke="var(--accent)" stroke-width="3"/>
  ${[54,66,78,90].map(y=>`<path d="M86 ${y} h68" stroke="var(--accent)" stroke-width="2" opacity=".5"/>`).join('')}
  <path d="M120 22 v-8" stroke="var(--accent)" stroke-width="2.5"/>
  ${[[42,54],[198,54],[42,84],[198,84]].map(([x,y])=>`
    <circle cx="${x}" cy="${y}" r="9" fill="var(--accent)" opacity=".45"/>
    <path d="M${x<120?x+13:x-13} ${y} h${x<120?46:-46}" stroke="var(--accent)"
      stroke-width="2" stroke-dasharray="4 4" opacity=".4"/>`).join('')}
  ${LB(120,126,'誰にでも同じに及ぶ条文')}`),
  rule: A(`
    <rect x="60" y="24" width="120" height="76" rx="5" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    ${[0,1,2].map(i=>`
      <rect x="72" y="${38+i*22}" width="12" height="12" rx="2" fill="var(--accent)" opacity="${i<2?0.9:0.35}"/>
      ${i<2?`<path d="M74 ${44+i*22} l3 4 6 -7" fill="none" stroke="var(--bg)" stroke-width="2"/>`:''}
      <path d="M94 ${44+i*22} h${70-i*14}" stroke="var(--accent)" stroke-width="2.5" opacity=".6"/>`).join('')}
    ${LB(120,124,'守るべき箇条')}`),
  order: A(SP2 + `
    ${[38,58,78].map((y,i)=>`
      <text x="26" y="${y+4}" font-size="11" fill="var(--accent)" opacity=".7"
        font-family="-apple-system,sans-serif">${i+1}</text>
      <rect x="38" y="${y-7}" width="${56-i*8}" height="14" rx="3" fill="var(--accent)"
        opacity="${0.8-i*0.2}"/>`).join('')}
    ${LB(61,124,'順序')}
    <rect x="146" y="34" width="70" height="52" rx="4" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    ${[48,62].map(y=>`<path d="M158 ${y} h46" stroke="var(--accent)" stroke-width="2" opacity=".5"/>`).join('')}
    <path d="M158 76 h22" stroke="var(--accent)" stroke-width="3"/>
    <path d="M196 76 l8 -8 8 8" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    ${LB(180,124,'注文・命令')}`),
  system: A(`
    <circle cx="120" cy="60" r="14" fill="var(--accent)"/>
    ${[[58,34],[182,34],[46,80],[194,80],[120,104]].map(([x,y])=>`
      <circle cx="${x}" cy="${y}" r="10" fill="var(--accent)" opacity=".5"/>
      <path d="M120 60 L${x} ${y}" stroke="var(--accent)" stroke-width="2" opacity=".4"/>`).join('')}
    ${LB(120,128,'つながって働く全体')}`),
  method: A(`
    <circle cx="34" cy="66" r="11" fill="var(--accent)" opacity=".5"/>
    ${[0,1,2].map(i=>`
      <rect x="${62+i*46}" y="52" width="32" height="28" rx="4" fill="var(--accent)" opacity="${0.45+i*0.18}"/>
      <path d="M${98+i*46} 66 h${i<2?10:0}" stroke="var(--accent)" stroke-width="2.5"/>
      ${i<2?`<path d="M${112+i*46} 66 l-8 4 v-8 z" fill="var(--accent)"/>`:''}`).join('')}
    <circle cx="206" cy="66" r="11" fill="var(--accent)"/>
    ${LB(120,120,'決まった手順')}`),
  way: A(SP2 + `
    <path d="M30 98 q14 -40 32 -44 q18 -4 30 -30" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <path d="M96 20 l-12 4 4 10 z" fill="var(--accent)"/>
    ${LB(61,124,'道すじ')}
    ${[0,1,2].map(i=>`
      <rect x="${146+i*26}" y="56" width="20" height="20" rx="3" fill="var(--accent)" opacity="${0.45+i*0.2}"/>
      ${i<2?`<path d="M${168+i*26} 66 h4" stroke="var(--accent)" stroke-width="2"/>`:''}`).join('')}
    ${LB(180,124,'やり方')}`),
  purpose: A(`
    <circle cx="164" cy="60" r="34" fill="none" stroke="var(--accent)" stroke-width="2.5" opacity=".3"/>
    <circle cx="164" cy="60" r="21" fill="none" stroke="var(--accent)" stroke-width="2.5" opacity=".55"/>
    <circle cx="164" cy="60" r="9" fill="var(--accent)"/>
    <circle cx="40" cy="60" r="11" fill="var(--accent)" opacity=".5"/>
    <path d="M56 60 h84" stroke="var(--accent)" stroke-width="3" stroke-dasharray="7 5"/>
    <path d="M154 60 l-12 6 v-12 z" fill="var(--accent)"/>
    ${LB(120,120,'そのためにやる、という先')}`),
  health: A(SP2 + `
    <path d="M61 96 C22 68 24 40 46 40 c9 0 16 7 15 12 1 -5 8 -12 17 -12 22 0 24 28 -17 56 z"
      fill="var(--accent)" opacity=".8"/>
    <path d="M24 66 h14 l6 -12 8 24 7 -16 5 4 h14" fill="none" stroke="var(--bg)" stroke-width="2.5"/>
    ${LB(61,124,'体が整っている')}
    <rect x="152" y="46" width="56" height="44" rx="4" fill="var(--accent)" opacity=".7"/>
    <rect x="174" y="54" width="12" height="28" rx="2" fill="var(--bg)"/>
    <rect x="166" y="62" width="28" height="12" rx="2" fill="var(--bg)"/>
    ${LB(180,124,'保健・医療')}`),
  disease: A(`
    <circle cx="120" cy="60" r="26" fill="var(--accent)" opacity=".35"/>
    ${[0,45,90,135,180,225,270,315].map(a=>{const r=a*Math.PI/180;
      return `<circle cx="${120+34*Math.cos(r)}" cy="${60+34*Math.sin(r)}" r="5"
        fill="var(--accent)" opacity=".7"/>`}).join('')}
    <path d="M110 50 l20 20 M130 50 l-20 20" stroke="var(--accent)" stroke-width="3" stroke-linecap="round"/>
    ${LB(120,124,'体を侵すもの')}`),
  drug: A(SP2 + `
    <rect x="30" y="52" width="62" height="28" rx="14" fill="none" stroke="var(--accent)" stroke-width="2.5"
      transform="rotate(-20 61 66)"/>
    <path d="M61 66 m-16 -12 a14 14 0 0 1 0 0" fill="none"/>
    <path d="M47 78 L75 54" stroke="var(--accent)" stroke-width="2.5"/>
    <path d="M34 60 q12 -14 26 -4 l-14 18 q-14 -6 -12 -14 z" fill="var(--accent)" opacity=".6"/>
    ${LB(61,120,'薬')}
    <path d="M158 40 l44 44 M202 40 l-44 44" stroke="var(--accent)" stroke-width="4"
      stroke-linecap="round" opacity=".55"/>
    <rect x="160" y="42" width="40" height="40" rx="6" fill="none" stroke="var(--accent)"
      stroke-width="2.5" opacity=".4"/>
    ${LB(180,120,'麻薬（禁じられる側）')}`),
  travel: A(`
    <circle cx="120" cy="60" r="34" fill="none" stroke="var(--accent)" stroke-width="2.5"/>
    <ellipse cx="120" cy="60" rx="14" ry="34" fill="none" stroke="var(--accent)" stroke-width="2" opacity=".6"/>
    <path d="M88 48 h64 M86 72 h68" stroke="var(--accent)" stroke-width="2" opacity=".6"/>
    <path d="M46 92 q30 -18 40 -34" fill="none" stroke="var(--accent)" stroke-width="2.5"
      stroke-dasharray="5 4"/>
    <path d="M154 26 q22 10 40 8" fill="none" stroke="var(--accent)" stroke-width="2.5"
      stroke-dasharray="5 4"/>
    <path d="M200 32 l-12 -4 2 10 z" fill="var(--accent)"/>
    ${LB(120,124,'遠くへ移動する')}`),
  trip: A(`
    <path d="M30 96 h180" stroke="var(--accent)" stroke-width="2" opacity=".3"/>
    <circle cx="44" cy="82" r="10" fill="var(--accent)"/>
    <path d="M56 78 q50 -50 118 -2" fill="none" stroke="var(--accent)" stroke-width="3" stroke-dasharray="6 5"/>
    <path d="M182 82 q-6 -10 -8 -6" fill="none" stroke="var(--accent)" stroke-width="3"/>
    <circle cx="190" cy="82" r="10" fill="var(--accent)" opacity=".5"/>
    <path d="M120 36 v-10" stroke="var(--accent)" stroke-width="2" opacity=".4"/>
    ${LB(120,24,'行って帰るまで')}
    ${LB(120,124,'ひと区切りの旅')}`)
  };
})();
