...
bar: [['棒・横木', 'An iron bar blocked the gate.', '鉄の棒が門をふさいでいた。'],
  ['酒場', 'We met at a small bar near the station.', '駅前の小さな店で会った。']],
cross: [['渡る', 'Look both ways before you cross.', '渡る前に左右を見なさい。'],
  ['十字', 'She wore a small silver cross.', '彼女は小さな銀の十字を着けていた。']],
press: [['押す', 'Press this button to start.', '始めるにはこのボタンを押す。'],
  ['報道機関', 'The press was waiting outside.', '報道陣が外で待っていた。']],
...
const VOCAB_TRIVIA = {
/* ---- 図の左右がつながっている理由 ---- */
press: ['「押す」が「報道機関」になった理由',
  '活字に紙を押しつけるのが印刷だった。'+
  'その機械が the press と呼ばれ、機械が刷るもの＝新聞、'+
  '新聞を作る人たち＝報道機関、と意味が移っていった。'+
  'press conference（記者会見）の press も、もとはこの機械のこと。'],
plant: ['「植物」と「工場」が同じ語である理由',
  '中心にあるのは「植える＝据えて動かなくする」。'+
  '土に据えるのが植物、機械を土地に据え付けるのが plant（据え付ける）で、'+
  '据え付けられた設備一式がそのまま「工場」になった。'+
  '日本語の「プラント建設」は、この工場のほうの plant。'],
bar: ['「棒」が「酒場」になった理由',
  '酒場のカウンターは、客と酒樽を隔てる横木（bar）だった。'+
  '仕切りの横木という意味は法廷にも残っていて、'+
  '傍聴席と法廷を分ける柵が bar、そこから barrister（法廷弁護士）が出ている。'+
  'barrier（障壁）も同じ一族。'],
country: ['「国」と「田舎」が同じ語である理由',
  'ラテン語 contrata は「向かい側に広がる土地」。'+
  '目の前に広がる土地、という一語が、'+
  '「自分たちの土地＝国」にも「街から見て向こう側＝田舎」にもなった。'+
  'どちらを向いて言っているかだけの違い。'],
office: ['「事務所」と「職」が同じ語である理由',
  'ラテン語 officium は「務め・役目」。'+
  '役目そのものが「職」、役目を果たす場所が「事務所」になった。'+
  'take office（就任する）は場所ではなく役目のほうの意味。'+
  'officer（役人）、official（公式の）も同じ一族。'],
cross: ['「十字」から「渡る」が出た理由',
  '十字は2本の線が交わった形。'+
  '交わるという意味が動詞になり、'+
  '道と自分の進路が交わる＝「横切る」になった。'+
  'across も同じ語からで、cross-（交差する）は crossroads や crossword にも残る。'],
